...
//!
//! The sources themselves live elsewhere: [`super::credentials`] holds grans's
//! own session and [`super::local_store`] reads the one Granola's desktop app
//! stored. This module is the order they are tried in.
